        ...
        <div className="w-full h-screen flex flex-col justify-center items-center bg-base-100 gap-10">
            ...
            <div className="flex justify-center gap-5">
                ...
                <span className="badge badge-warning badge-lg">
                    FastAPI / React / Vue / Electron / MySQL
                </span>
            </div>
        ...
        <div className="w-full h-screen flex flex-col justify-center items-center bg-base-100 gap-10">
            ...
            <div className="flex flex-col gap-3">
                {[
                    ...
                    <div
                        key={idx}
                        className="flex items-center gap-3 bg-base-200 shadow-xl rounded-xl p-5"
                    >
            ...
            <div className="grid grid-cols-4 gap-5">
                {[
                    ...
                    return (
                        <span
                            key={tech}
                            className={`badge badge-soft w-full text-xl rounded-xl badge-${color} p-5`}
                        >
                            {tech}
                        </span>
                    )
